...
Route::get('/samerankprofite', [App\Http\Controllers\UserPanel\Bonus::class, 'activitiesBonus'])->name('user.samerankprofite');
Route::get('/salary_income', [App\Http\Controllers\UserPanel\Bonus::class, 'salary_income'])->name('user.salary_income');
...
Route::get('recurring-bonus', [App\Http\Controllers\Admin\BonusController::class, 'recurring_bonus'])->name('admin.reward-bonus');
