          ...
          <div class="card-body">
            ...
            <table id="zero-conf" class="data-table" style="width:100%">
              ...
              <tbody>
                ...
                ?>
                <tr class="text-center">
                  <td colspan="{{ $directCount*2 }}" style="border-color:#ffffff; background-color:#202020;"
                    class="text-center">
                    <input type="image" name="ctl00$ContentPlaceHolder1$ImageButton0"
                      ...
                      src="{{ asset('users/images/') }}/{{ $color }}.png"
                      style="border-width: 0px; width: 125px; height: 70px; background: #202020;">
                    <br>
                ...
                <tr class="text-center">
                  ...
                  <?php if (is_array($direct_team) || is_object($direct_team)) { ?>
                    ...
                    <td colspan="2" style="border-color:#ffffff; background-color:#202020;" class="text-center"><a
