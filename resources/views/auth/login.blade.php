								...
								<div class="auth-form">
									...
									<form action="{{ route('loginAction') }}" method="post" style="margin-top:28px;">
										...
										<div class="mb-3">
											...
											<input type="text" name="username" class="form-control" placeholder="please enter username" value="">
										</div>
										<div class="mb-3">
											<label class="mb-1"><strong>Password</strong></label>
											<input type="password" name="password" class="form-control" placeholder="please enter password"  value="">
										</div>
