			...
			<div class="col-lg-12 text-center">
				<div class="breadcumb-content">
					<div class="breadcumb-title">
						<h4>🌊 Ocean Clean-Up: Protecting the Blue Heart of Our Planet</h4>
					</div>
					<ul>
						<li><a href="index.html"><img src="assets/images/inner-images/breadcumb-text-shape.png" alt="">Echofy</a></li>
						<li>Blog Details</li>
						<li class="khela-hbe">🌊 Ocean Clean-Up: Protecting the Blue Heart of Our Planet</li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="blog-details-content">
							...
							<h4 class="blog-details-title">🌊 Ocean Clean-Up: Protecting the Blue Heart of Our Planet.</h4>

							<p class="blog-details-desc">The ocean covers over 70% of the Earth’s surface, generates more than half of the oxygen we breathe, and supports countless species of marine life. It’s also a vital part of our economy and food supply. Yet, despite its importance, the ocean is choking under the weight of plastic waste, chemical pollution, and human negligence.</p>	

							<p class="blog-details-desc">Ocean clean-up is not just an environmental duty — it’s a global emergency. Here's why it matters and how we can all be part of the solution.</p>
							...
							<div class="blog-details-author-talk">
								...
								<div class="blog-details-author-title">
									<p>CEvery year, over 11 million metric tons of plastic enter the oceans — that's equivalent to dumping a garbage truck full of plastic into the sea every minute. This waste threatens marine ecosystems, kills wildlife, and even makes its way into the food chain through microplastics.</p>
                            ...
                            <div class="blog-details-list-item">
                            	<ul>
                            		<li><i class="bi bi-check-circle-fill"></i>Single-use plastics (bags, bottles, straws)</li>
                            		<li><i class="bi bi-check-circle-fill"></i>Abandoned fishing gear</li>
                            		<li><i class="bi bi-check-circle-fill"></i>Industrial and chemical runoff</li>
                            		<li><i class="bi bi-check-circle-fill"></i>Sewage discharge</li>
                            	</ul>
                            </div>
                            <div class="row">
                            	<div class="col-lg-6 col-md-6">
                            ...
                            <h3 class="blog-details-title two">🌱 2. Preserving Biodiversity</h3>

                            <p class="blog-details-desc three">Oceans are home to more species than land. Clean waters allow coral reefs, mangroves, and marine life to thrive.</p>
						</div>
