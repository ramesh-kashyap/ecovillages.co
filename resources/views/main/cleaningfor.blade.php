				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="blog-details-content">
							...
							<h4 class="blog-details-title">🌲 Cleaning Forests: A Step Toward a Greener Planet</h4>

							<p class="blog-details-desc">Forests are often called the lungs of our planet, providing clean air, rich biodiversity, and a natural sanctuary for humans and wildlife alike. Yet, these lush green spaces are increasingly under threat — not just from deforestation and climate change, but from something more avoidable: pollution and litter.</p>	

							<p class="blog-details-desc">Cleaning forests is more than just an act of environmental responsibility — it is a movement that protects ecosystems, inspires communities, and builds a sustainable future.</p>
							...
							<div class="blog-details-author-talk">
								...
								<div class="blog-details-author-title">
									<p>Litter such as plastic bottles, wrappers, and discarded cans can be deadly for forest animals.</p>
									<span>CEO & Founder</span>
								</div>
							</div>

                            <h3 class="blog-details-title">Encouraging Eco-Conscious Behavior</h3>

                            <p class="blog-details-desc two">Community cleanups inspire others to take responsibility for their environment. When people see clean, well-maintained forests, they are more likely to treat them with respect.</p>

                            <div class="blog-details-list-item">
                            	<ul>
                            		<li><i class="bi bi-check-circle-fill"></i>Organize a Cleanup Drive</li>
                            		<li><i class="bi bi-check-circle-fill"></i>Plan and Prepare</li>
                            		<li><i class="bi bi-check-circle-fill"></i>Work with Local Authorities</li>
                            		<li><i class="bi bi-check-circle-fill"></i>Educate and Advocate</li>
                            	</ul>
                            </div>
                            <div class="row">
                            	<div class="col-lg-6 col-md-6">
                            ...
                            <h3 class="blog-details-title two">The Long-Term Impact</h3>

                            <p class="blog-details-desc three">Forests give us oxygen, shelter, food, and peace — and all they ask in return is care. By participating in forest cleanups, we’re not just cleaning nature; we’re healing it. Every bottle picked, every plastic removed, is a step toward a greener, cleaner Earth.</p>
						</div>
